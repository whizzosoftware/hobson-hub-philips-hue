...
public class HueBridgeParserTest {
    ...
    public void testParseGetLightAttributeAndState() throws HueException {
        ...
        response = (GetLightAttributeAndStateResponse)parser.parseGetLightAttributeAndStateResponse("", 200, "{\"state\": {\"on\":false,\"bri\":254,\"hue\":65535,\"sat\":254,\"xy\":[0.700,0.200],\"ct\":500,\"alert\":\"none\",\"effect\":\"none\",\"colormode\":\"ct\",\"reachable\":true}, \"type\": \"Extended color light\", \"name\": \"Hue Downlight\", \"modelid\": \"LCT002\", \"swversion\": \"66010673\", \"pointsymbol\": { \"1\":\"none\", \"2\":\"none\", \"3\":\"none\", \"4\":\"none\", \"5\":\"none\", \"6\":\"none\", \"7\":\"none\", \"8\":\"none\" }}");
        state = response.getState();
        assertEquals("none", state.getEffect());
        assertEquals(254, (int)state.getBrightness());
        assertTrue(state.hasColorTemperature());
        assertEquals(500, (int)state.getColorTemperature());
        assertEquals(true, state.isReachable());
        assertEquals(false, state.getOn());
    }
